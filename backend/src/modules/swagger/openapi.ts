...
export const openApiDocument = {
  ...
  paths: {
    ...
    "/ready": { get: { tags: ["Operations"], summary: "Readiness probe", description: "Checks PostgreSQL, Redis, and Cloudinary.", responses: { "200": jsonResponse("All dependencies are healthy"), "503": jsonResponse("One or more dependencies are unhealthy") } } },
    ...
    "/api/v1/notifications/email": { post: { tags: ["Notifications"], summary: "Send email notification", security: bearerAuth, requestBody: body(schemas.notification, "Email notification"), responses: responses("202", "Email sent") } },
    "/api/v1/invoice/{orderId}": { get: { tags: ["Invoices"], summary: "Download invoice PDF", security: bearerAuth, parameters: [pathParameter("orderId")], responses: { "200": pdfResponse("Generated invoice PDF"), "401": { $ref: "#/components/responses/Unauthorized" }, "404": { $ref: "#/components/responses/NotFound" }, "500": { $ref: "#/components/responses/InternalError" } } } },
